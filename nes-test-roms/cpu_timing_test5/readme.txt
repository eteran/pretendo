...
address). BRK is handled by setting the IRQ vector to $0202, the address
of the next instruction in the loop after BRK. The trickiness of these
special cases might reveal non-timing problems in an emulator.
