...
// Name: write_8
//------------------------------------------------------------------------------
void VRC6::write_8(uint_least16_t address, uint8_t value) {
...
// Name: write_9
//------------------------------------------------------------------------------
void VRC6::write_9(uint_least16_t address, uint8_t value) {
...
// Name: write_a
//------------------------------------------------------------------------------
void VRC6::write_a(uint_least16_t address, uint8_t value) {
...
// Name: write_b
//------------------------------------------------------------------------------
void VRC6::write_b(uint_least16_t address, uint8_t value) {
	switch (address & 0xf003) {
	case 0xb000:
		// saw volume
		break;
...
// Name: write_c
//------------------------------------------------------------------------------
void VRC6::write_c(uint_least16_t address, uint8_t value) {
	switch (address & 0xf003) {
	case 0xc000:
	case 0xc001:
	case 0xc002:
...
// Name: write_d
//------------------------------------------------------------------------------
void VRC6::write_d(uint_least16_t address, uint8_t value) {
	switch (address & 0xf003) {
	case 0xd000:
...
// Name: write_e
//------------------------------------------------------------------------------
void VRC6::write_e(uint_least16_t address, uint8_t value) {
	switch (address & 0xf003) {
	case 0xe000:
...
// Name: write_f
//------------------------------------------------------------------------------
void VRC6::write_f(uint_least16_t address, uint8_t value) {
	switch (address & 0xf003) {
	case 0xf000:
		irq_latch_ = value;
		break;
