...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_4(uint_least16_t address) {
	if (address >= 0x4020) {
...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_5(uint_least16_t address) {
	return ram_[address & 0x03];
}
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_4(uint_least16_t address, uint8_t value) {
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_5(uint_least16_t address, uint8_t value) {
	ram_[address & 0x03] = value & 0x03;
}
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_8(uint_least16_t address, uint8_t value) {
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_9(uint_least16_t address, uint8_t value) {
	write_hander(address, value);
}
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_a(uint_least16_t address, uint8_t value) {
	write_hander(address, value);
}
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_b(uint_least16_t address, uint8_t value) {
	write_hander(address, value);
}
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_c(uint_least16_t address, uint8_t value) {
	write_hander(address, value);
}
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_d(uint_least16_t address, uint8_t value) {
	write_hander(address, value);
}
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_e(uint_least16_t address, uint8_t value) {
	write_hander(address, value);
}
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_f(uint_least16_t address, uint8_t value) {
	write_hander(address, value);
}
...
// Name:
//------------------------------------------------------------------------------
void Mapper228::write_hander(uint_least16_t address, uint8_t value) {
...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_8(uint_least16_t address) {
...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_9(uint_least16_t address) {
	if (rom_[1]) {
...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_a(uint_least16_t address) {
	if (rom_[2]) {
...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_b(uint_least16_t address) {
	if (rom_[3]) {
...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_c(uint_least16_t address) {
	if (rom_[4]) {
...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_d(uint_least16_t address) {
	if (rom_[5]) {
...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_e(uint_least16_t address) {
	if (rom_[6]) {
...
// Name:
//------------------------------------------------------------------------------
uint8_t Mapper228::read_f(uint_least16_t address) {
	if (rom_[7]) {
