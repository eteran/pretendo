...
// Name:
//------------------------------------------------------------------------------
DMC::DMC() : enabled_(false), current_address_(0xc000), sample_address_(0xc000), bytes_remaining_(0), sample_length_(0), irq_enabled_(0x80), load_counter_(0), loop_(0), sample_shift_counter_(0) {
}
